...
extern "C" {
    #[link_name = "\u{1}__Z10prvhash16_PKvmPvmj"]
    pub fn prvhash16_(
...
extern "C" {
    #[link_name = "\u{1}__Z10prvhash64_PKvmPvmyS0_"]
    pub fn prvhash64_(
        Msg0: *const ::std::os::raw::c_void,
        MsgLen: usize,
        Hash0: *mut ::std::os::raw::c_void,
...
extern "C" {
    #[link_name = "\u{1}__Z14prvhash64_64m_PKvmy"]
    pub fn prvhash64_64m_(Msg0: *const ::std::os::raw::c_void, MsgLen: usize, UseSeed: u64) -> u64;
}
extern "C" {
    #[link_name = "\u{1}__Z16prvhash64s_init_P14PRVHASH64S_CTXPvmPKyPKv"]
...
extern "C" {
    #[link_name = "\u{1}__Z18prvhash64s_update_P14PRVHASH64S_CTXPKvm"]
...
extern "C" {
    #[link_name = "\u{1}__Z17prvhash64s_final_P14PRVHASH64S_CTX"]
    pub fn prvhash64s_final_(ctx: *mut PRVHASH64S_CTX);
}
extern "C" {
    #[link_name = "\u{1}__Z19prvhash64s_oneshot_PKvmPvm"]
