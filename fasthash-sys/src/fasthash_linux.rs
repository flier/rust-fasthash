...
pub const PRH64S_MAX: u32 = 512;
pub const PRH64S_PAR: u32 = 4;
#[repr(C)]
#[derive(Debug)]
...
extern "C" {
    #[link_name = "\u{1}_Z11MeowHash128PKviPvS1_"]
    pub fn MeowHash128(
        key: *const ::std::os::raw::c_void,
        len: ::std::os::raw::c_int,
...
extern "C" {
    #[link_name = "\u{1}_Z13MeowHashBeginP10meow_statePv"]
    pub fn MeowHashBegin(State: *mut meow_state, Seed128: *mut ::std::os::raw::c_void);
}
extern "C" {
    #[link_name = "\u{1}_Z14MeowHashUpdateP10meow_statemPv"]
...
extern "C" {
    #[link_name = "\u{1}_Z11MeowHashEndP10meow_statePv"]
    pub fn MeowHashEnd(State: *mut meow_state, out: *mut ::std::os::raw::c_void);
}
extern "C" {
    #[link_name = "\u{1}_Z18MeowHashExpandSeedyPvPh"]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct PRVHASH64S_CTX {
    #[doc = "< Current parallel \"Seed\" values."]
    pub Seed: [u64; 4usize],
    #[doc = "< Current parallel \"lcg\" values."]
    pub lcg: [u64; 4usize],
    #[doc = "< Working hash buffer."]
    pub Hash: [u8; 512usize],
    #[doc = "< Intermediate input data block."]
    pub Block: [u8; 32usize],
    #[doc = "< Message length counter, in bytes."]
    pub MsgLen: u64,
    #[doc = "< Pointer to the output hash buffer."]
    pub HashOut: *mut u8,
    #[doc = "< Hash buffer length, in bytes, >= PRH64S_S,"]
    #[doc = "< increments of PRH64S_S."]
    #[doc = "<"]
    pub HashLen: usize,
    #[doc = "< Hash buffer position."]
    pub HashPos: usize,
    #[doc = "< The number of bytes filled in the Block."]
    pub BlockFill: usize,
    #[doc = "< Final stream bit value, for hashing finalization."]
    pub fb: u8,
}
#[test]
fn bindgen_test_layout_PRVHASH64S_CTX() {
    assert_eq!(
        ::std::mem::size_of::<PRVHASH64S_CTX>(),
        656usize,
        concat!("Size of: ", stringify!(PRVHASH64S_CTX))
    );
    assert_eq!(
        ::std::mem::align_of::<PRVHASH64S_CTX>(),
        8usize,
        concat!("Alignment of ", stringify!(PRVHASH64S_CTX))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).Seed as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
            "::",
            stringify!(Seed)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).lcg as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).Hash as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).Block as *const _ as usize },
        576usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).MsgLen as *const _ as usize },
        608usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).HashOut as *const _ as usize },
        616usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).HashLen as *const _ as usize },
        624usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).HashPos as *const _ as usize },
        632usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).BlockFill as *const _ as usize },
        640usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PRVHASH64S_CTX>())).fb as *const _ as usize },
        648usize,
        concat!(
            "Offset of field: ",
            stringify!(PRVHASH64S_CTX),
...
extern "C" {
    #[link_name = "\u{1}_Z10prvhash16_PKvmPvmj"]
    pub fn prvhash16_(
        Msg0: *const ::std::os::raw::c_void,
        MsgLen: usize,
        Hash0: *mut ::std::os::raw::c_void,
        HashLen: usize,
        UseSeed: u32,
    );
}
extern "C" {
    #[link_name = "\u{1}_Z10prvhash64_PKvmPvmmS0_"]
    pub fn prvhash64_(
        Msg0: *const ::std::os::raw::c_void,
        MsgLen: usize,
        Hash0: *mut ::std::os::raw::c_void,
        HashLen: usize,
        UseSeed: u64,
        InitVec0: *const ::std::os::raw::c_void,
    );
}
extern "C" {
    #[link_name = "\u{1}_Z14prvhash64_64m_PKvmm"]
    pub fn prvhash64_64m_(Msg0: *const ::std::os::raw::c_void, MsgLen: usize, UseSeed: u64) -> u64;
}
extern "C" {
    #[link_name = "\u{1}_Z16prvhash64s_init_P14PRVHASH64S_CTXPvmPKmPKv"]
    pub fn prvhash64s_init_(
        ctx: *mut PRVHASH64S_CTX,
        Hash0: *mut ::std::os::raw::c_void,
        HashLen: usize,
        UseSeeds: *const u64,
        InitVec0: *const ::std::os::raw::c_void,
...
extern "C" {
    #[link_name = "\u{1}_Z18prvhash64s_update_P14PRVHASH64S_CTXPKvm"]
    pub fn prvhash64s_update_(
        ctx: *mut PRVHASH64S_CTX,
        Msg0: *const ::std::os::raw::c_void,
        MsgLen: usize,
    );
...
extern "C" {
    #[link_name = "\u{1}_Z17prvhash64s_final_P14PRVHASH64S_CTX"]
    pub fn prvhash64s_final_(ctx: *mut PRVHASH64S_CTX);
}
extern "C" {
    #[link_name = "\u{1}_Z19prvhash64s_oneshot_PKvmPvm"]
    pub fn prvhash64s_oneshot_(
...
extern "C" {
    #[link_name = "\u{1}_Z14HighwayHash128PKmPKcmRA2_m"]
...
extern "C" {
    #[link_name = "\u{1}_Z14HighwayHash256PKmPKcmRA4_m"]
...
extern "C" {
    #[link_name = "\u{1}_Z8wyhash64PKvmm"]
